...
Objective:	 To obtain parameters of a polynomial implementing Gauss-Newton Algorithm [ Refer Report/Manual ]
Input:		 Measured Data, Initial Guess of Parameters, Equation Type
Output:		 Parameters of the equation, Plot showing comparision of Obtained and Fitted Values, CSV Files containing Computed Hessians & Error Propogation
...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------*/
/*
Main Program, consists of: Data Sourcing from Input and CSV Files, Obtaining Parameters from Gauss-Newton Fit Routine
Arguments: None
